...
return {
	...
	config = function()
		...
		-- Enable telescope fzf native, if installed (i.e. protective call)
		pcall(require("telescope").load_extension, "fzf")

		-- Enable project integration with telescope, if install (i.e. protective call)
